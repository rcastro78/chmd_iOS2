...
func tableView(_ tableView: UITableView, prefetchRowsAt indexPaths: [IndexPath]) {
   ...
   @IBOutlet weak var barBusqueda: UISearchBar!
    ...
    @IBOutlet weak var imgEliminadas: UIImageView!
    @IBOutlet weak var imgFavoritas: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        imgFavoritas.isHidden=true
        imgNoLeidas.isHidden=true
        imgLeidas.isHidden=true
        imgEliminadas.isHidden=true
      ...
      self.tableViewCirculares.addSubview(refreshControl)
        ...
        /*
        let viaNotif:Int = UserDefaults.standard.integer(forKey: "viaNotif")
        if(viaNotif==1){
     ...
     @objc func seleccionMultiple(_ sender:UIButton){
        ...
        if let indexpath = tableViewCirculares.indexPath(for: cell){
            if(cell.chkSeleccionar.isChecked){
                ...
                imgFavoritas.isHidden=false
                imgEliminadas.isHidden=false

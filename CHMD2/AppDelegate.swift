   ...
   func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable: Any],
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter, didReceive response: UNNotificationResponse, withCompletionHandler completionHandler: @escaping () -> Void) {
        ...
        let aps = userInfo[AnyHashable("aps")] as? NSDictionary
              ...
              print("Notificaciones: \(title)")
              print("Notificaciones: \(body)")
              print("Notificaciones: \(idCircular)")
              print("Notificaciones badge: \(b)")
              //Mostrar el badge
              //UIApplication.shared.applicationIconBadgeNumber = b!
        /*
         Notificaciones: [AnyHashable(\"google.c.a.e\"): 1, AnyHashable(\"badge\"): 1, AnyHashable(\"aps\"): {\n    alert =     {\n        body = \"Nueva circular \";\n        title = PRUEBA;\n    };\n    \"content-available\" = 1;\n}, AnyHashable(\"body\"): , AnyHashable(\"gcm.notification.priority\"): high, AnyHashable(\"google.c.sender.id\"): 465701420614, AnyHashable(\"title\"): PRUEBA, AnyHashable(\"gcm.message_id\"): 1600396803409950, AnyHashable(\"priority\"): low, AnyHashable(\"content_available\"): true]
         */
            debugPrint("Notificaciones: \(userInfo)")
        ...
        // Esto funciona, pero pone la vista sin navbar
